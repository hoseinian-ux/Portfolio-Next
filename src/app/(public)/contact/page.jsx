    ...
    <section className="max-w-4xl mx-auto p-6 space-y-10">
      ...
      >
         ...
         <p className="text-xl font-bold text-justify leading-8">
            با عرض ادب و احترام <br></br>لطفا چنانچه سایت و توانایی های بنده نواقصی داشت بر من ببخشید و با دادن فرصت کار عملی در این حوزه به من این امکان را دهید تا پیشرفت کنم و بتوانم برای شرکتتان مفید فایده باشم. من بسیار پر تلاش هستم و آماده مواجهه با چالش های مختلف برای حل آنها هستم. <br></br> <span className="float-left"> با تشکر از شما </span>
          </p>
